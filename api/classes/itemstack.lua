...
---@return boolean
function ItemStackClass:is_empty() end

---@return string name ie: "default:stone"
function ItemStackClass:get_name() end

---Returns a boolean indicating whether the item was cleared.
---@param item_name string
---@return boolean cleared
function ItemStackClass:set_name(item_name) end

---Returns number of items on the stack.
---@return number
function ItemStackClass:get_count() end

---Returns a boolean indicating whether the item was cleared.
---@param count integer Unsigned 16 bit.
---@return boolean cleared
function ItemStackClass:set_count(count) end

---Returns tool wear (`0`-`65535`), `0` for non-tools.
---@return number
function ItemStackClass:get_wear() end

---Returns boolean indicating whether item was cleared.
---@param wear integer Unsigned 16 bit.
---@return boolean cleared
function ItemStackClass:set_wear(wear) end

---**DEPRECATED** Returns metadata (a string attached to an item stack).
---@return string
---@deprecated
function ItemStackClass:get_metadata() end

---**DEPRECATED**
---@param metadata string
---@return true
---@deprecated
function ItemStackClass:set_metadata(metadata) end
...
---  * item name.
---@return string
function ItemStackClass:get_description() end
...
function ItemStackClass:add_wear_by_uses(max_uses) end

---* Returns leftover `ItemStack`.
---* Put some item or stack onto this stack.
---@param item mt.ItemStack
---@return mt.ItemStack leftover
function ItemStackClass:add_item(item) end

---Returns `true` if item or stack can be fully added to this one.
---@param item mt.ItemStack
---@return boolean
function ItemStackClass:item_fits(item) end

---* Returns taken `ItemStack`.
---* Take (and remove) up to `n` items from this stack.
---@param n number|nil Default: `1`.
---@return mt.ItemStack taken
function ItemStackClass:take_item(n) end

---* Returns taken `ItemStack`.
---* Copy (don't remove) up to `n` items from this stack.
---@param n number|nil Default: `1`.
---@return mt.ItemStack taken
function ItemStackClass:peek_item(n) end
...
function ItemStackClass:equals(other) end
